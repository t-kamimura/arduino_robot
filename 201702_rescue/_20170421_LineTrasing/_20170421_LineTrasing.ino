...
// 各種変数・定数の設定
const int ledPin = 3;           // LEDは3番ピン
const int inPin = 11;           // デジタルピン11にスイッチ
const int analogPin1 = 2;       // ラインセンサー(1)
const int analogPin2 = 3;       // ラインセンサー(2)

int val = 0;              // デジタルピン11の状態
int analogVal1 = 0;       // ラインセンサー(1)の値保存用
int analogVal2 = 0;       // ラインセンサー(2)の値保存用
int threshold_analog = 30;    // 赤外線測距しきい値
const int kp = 1;
